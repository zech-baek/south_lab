...
# customizing module
from project.temp.temp_function import function
...
class project(cui_frame, function):
    ...
    def __init__(self, **kwargs):
        ...
        if not emulator or not self.revision or not self.revision:
            ...
            i2c = allcoation.bridge_allcoation(emulator=emulator, logging=logging)
            
            super().__init__(regmap=reg_map, i2c_info=i2c_info, i2c_h=i2c, device=self.device, logging=logging, is_gui=is_gui)
