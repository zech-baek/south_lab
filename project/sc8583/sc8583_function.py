...
class function:
    ...
    def m3_init_ref(self, mode):
        ...
        self.obj.VBAT_REG=0xd8
        self.obj.IBAT_REG_DIS=0x1
        self.obj.IBAT_REG=0x68    
        self.obj.VBAT_REG_DIS=0x1
